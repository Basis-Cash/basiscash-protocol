...
module.exports = async (deployer, network, accounts) => {
  ...
  //Transfer Bond operater & ownership to treasury.address
  // console.log(bond.address, " transferOperator to", treasury.address);
  // await bond.transferOperator(treasury.address);

  // console.log(bond.address, " transferOwnership to", treasury.address);
  // await bond.transferOwnership(treasury.address);
